...
meta_dict = {'haim': tr.MetaData(frequency=18.8, polarization=0, length=4 * 1.4, height_far=25, height_near=25),
             'air_port': tr.MetaData(frequency=23.3, polarization=1, length=4 * 2.5, height_far=14, height_near=17)}

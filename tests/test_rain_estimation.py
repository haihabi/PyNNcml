...
class TestRainEstimation(unittest.TestCase):
    ...
    def test_two_step_constant_wa_factor(self):
        att = torch.ones(10, 100)
        swd = tr.rain_estimation.two_step_constant_baseline(tr.power_law.PowerLawType.MAX, 0.3, 6, 0.5, wa_factor=-1)
    ...
    def test_one_step_dynamic(self):
        att = torch.ones(10, 100)
        model = tr.rain_estimation.one_step_dynamic_baseline(tr.power_law.PowerLawType.MAX, 0.3, 6)

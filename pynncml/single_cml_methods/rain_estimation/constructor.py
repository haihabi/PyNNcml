...
def two_step_network(n_layers: int=2, rnn_type: DNNType=DNNType.GRU,
    ...
    model = TwoStepNetwork(n_layers, rnn_type, normalization_cfg, enable_tn=enable_tn, tn_alpha=tn_alpha,
                           ...
                           input_data_type=AttenuationType.MinMax, input_rate=900, output_rate=900)
...
def one_step_network(n_layers: int=2,
                     rnn_type: DNNType=DNNType.GRU,
                     normalization_cfg: InputNormalizationConfig = INPUT_NORMALIZATION,
                     enable_tn: bool = False,
                     tn_alpha: float = 0.9,
                     rnn_input_size: int = DYNAMIC_INPUT_SIZE,

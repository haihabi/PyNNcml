...
from pynncml.neural_networks.nn_config import DNNType
...
MODEL_ZOO = {
    ModelType.ONESTEP: {DNNType.GRU: {1: 'one_step_1_rnntype_best.gru',
                                      2: 'one_step_2_rnntype_best.gru',
                                      3: 'one_step_3_rnntype_best.gru'},
                        DNNType.LSTM: {1: 'one_step_1_rnntype_best.lstm',
                                       2: 'one_step_2_rnntype_best.lstm',
                                       3: 'one_step_3_rnntype_best.lstm'}},
    ModelType.TWOSTEP: {DNNType.GRU: {1: 'two_step_1_rnntype_best.gru',
                                      2: 'two_step_2_rnntype_best.gru',
                                      3: 'two_step_3_rnntype_best.gru'},
                        DNNType.LSTM: {1: 'two_step_1_rnntype_best.lstm',
                                       2: 'two_step_2_rnntype_best.lstm',
                                       3: 'two_step_3_rnntype_best.lstm'}},
    ModelType.WETDRY: {DNNType.GRU: {1: 'wet_dry_1_rnntype_best.gru',
                                     2: 'wet_dry_2_rnntype_best.gru',
                                     3: 'wet_dry_3_rnntype_best.gru'},
                       DNNType.LSTM: {1: 'wet_dry_1_rnntype_best.lstm',
...
def get_model_from_zoo(model_type: ModelType, rnn_type: DNNType, n_layers: int) -> str:
    """
